...
<blockquote>🌿 ᴍᴀɪɴᴛᴀɪɴᴇᴅ ʙʏ : <a href='https://t.me/TvShOw076'>×𝐌𝐫.𝐀𝐦</a></b></blockquote>"""
...
"""
    ...
    FILE_CAPTION = """<b>{file_name}\n\n𝖩𝗈𝗂𝗇➥ 『<a href='https://t.me/faishonhub00'>𝗙𝗮𝗶𝘀𝗵𝗼𝗻 𝗛𝘂𝗯</a>』</b>"""
...
#verified_{}_completed"""
    ...
    MOVIES_UPDATE_TXT = """<b> {files.file_name[:20]} Hindi hdrip - Is Now Available ‼️<blockquote>📌 Note : If You Need To Get All Quality Files , Please Copy The Above Movie Name And Paste It Into The Below Movie Search Group 🔰.</blockquote> </b>"""
...
--------------Set Ads----------------
➩ /set_ads {ads name}}#{Times}#{photo URL} - <a href="https://t.me/TvShOw076">Owner</a>
➩ /del_ads - Delete ads
-------------Top Trending------------
➩ /setlist {Mirzapur, Money Heist} - <a href=https://t.me/TvShOw076>Owner</a>
...
-----------Set Imdb Template-----------
/set_template - set IMDb template <a href="https://t.me/TvShOw076">Owner</a>
--------------Set Tutorial-------------
...
Aᴅᴅ ᴍᴇ ᴛᴏ ʏᴏᴜʀ ɢʀᴏᴜᴘ ᴀɴᴅ ᴍᴀᴋᴇ ᴍᴇ ᴀᴅᴍɪɴ ᴀɴᴅ ᴜsᴇ ᴀʟʟ ғᴇᴀᴛᴜʀᴇs😇</b>"""
    ...
    SOURCE_TXT = """<b>
NOTE:
- Create Your Bot ◉› :<blockquote><a href="https://t.me/TvShOw076">𝗧𝘃𝘀𝗵𝗼𝘄 𝗕𝗼𝘁</a></blockquote>
